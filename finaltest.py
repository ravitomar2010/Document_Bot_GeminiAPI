...
def ask_and_get_answer(vector_store, q, k):
    ...
    docs = vector_store.similarity_search(q, k=k)  # Use k for number of results
    ...
    template = '''You Are DocAI Assistant.Answer the question as detailed as possible from the provided {context}, make sure to provide all the details, if the answer is not in provided context please cross check again and make sure answer really does not exist there might be deveral ways to ask a question for same so be aware of it and if it relaly does not exist in {context} just say, "answer is not available in the context", don't provide the wrong answer
    ...
    return answer.content # Extract the content from the AIMessage object
